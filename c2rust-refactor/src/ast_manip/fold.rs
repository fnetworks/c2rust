...
pub trait MutVisitor: Sized {
    ...
    // fn visit_mac_call(&mut self, _mac: &mut Mac) {
    //     panic!("visit_mac_call disabled by default");
    //     // N.B., see note about macros above. If you really want a visitor that
    //     // works on macros, use this definition in your trait impl:
    //     //   mut_visit::noop_visit_mac_call(_mac, self);
    // }
    ...
    fn flat_map_expr_field(&mut self, f: ExprField) -> SmallVec<[Field; 1]> {
    ...
    fn flat_map_pat_field(&mut self, fp: PatField) -> SmallVec<[FieldPat; 1]> {
